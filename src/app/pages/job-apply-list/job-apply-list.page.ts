...
@Component({
  ...
  templateUrl: './job-apply-list.page.html',
  styleUrls: ['./job-apply-list.page.scss'],
})
// End here


export class JobApplyListPage implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // ------ init function call start -------
      commonFunction(){
        ...
        this.headerUrlapi = 'job_applicant/frontend_header';
    
        // table list data url name
        this.listing_url = 'job_applicant/frontend_return_index';
